...
export default function Collaboration(){
    return (
        <section className="bg-[#F5F8FE]  w-full py-16 md:py-24 text-center">
            ...
            <div className='mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 justify-items-center items-center gap-12 max-w-5xl mx-auto'>
                ...
                <Image  src="/aug.png" alt="company logo" width={200} height={50}/>
                <Image  src="/logo-6.png" alt="company logo" width={90} height={37}/>
                <Image  src="/IUG.png" alt="company logo" width={70} height={37}/>
                <Image  src="/aqsa-uni.png" alt="company logo" width={135} height={37}/>
